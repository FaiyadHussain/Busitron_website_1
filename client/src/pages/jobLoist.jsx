...
const JobList = () => {
  ...
  const updateJob = async () => {
    try {
      const response = await axios.put(`https://busitron-website-1.onrender.com/admin/updateJob/${editJob._id}`, formData, {
        headers: { Authorization: token },
      });
  ...
  const deleteJob = async (id) => {
    try {
      await axios.delete(`https://busitron-website-1.onrender.com/admin/deleteJob/${id}`, {
        headers: { Authorization: token },
      });
