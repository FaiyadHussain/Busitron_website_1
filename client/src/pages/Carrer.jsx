        ...
        <Suspense fallback={<JobSkeleton />}>
          <div className="space-y-8">
            {loading ? (
              ...
              jobs.map((job) => (
                <div key={job._id} className="bg-gray-900 p-8 rounded-lg shadow-lg border-l-8 border-blue-500 transition-transform duration-300 ease-in-out hover:scale-105">
                  ...
                  <button
                    className="mt-6 bg-blue-500 hover:bg-blue-600 text-white font-semibold py-3 px-6 rounded-lg transition-all"
